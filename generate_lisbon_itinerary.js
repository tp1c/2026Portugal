...
async function run() {
  try {
    ...
    const scheduleValues = [
      ...
      ['Day 5 (Wed Jul 22)', '08:30 AM', 'Lisbon to Porto Transfer (Coimbra Stop)', 'Viking Motorcoach transfer (approx. 4-4.5 hours total travel time).', 'Checkout from Corinthia Hotel. Board the Viking motorcoach for your scenic transfer north. Luggage will be handled directly for you.'],
      ['Day 5 (Wed Jul 22)', '11:30 AM', 'Coimbra Sightseeing & Included Lunch', 'Moderate walking on slopes. Coimbra University (UNESCO World Heritage Site).', 'Explore the historic university grounds, including the spectacular Joanina Library. Enjoy a traditional lunch (included) in Coimbra before continuing to Porto.'],
      ['Day 5 (Wed Jul 22)', '03:30 PM', 'Porto Embarkation (Vila Nova de Gaia)', 'Board the Viking Osfrid docked at Vila Nova de Gaia. Settle into your stateroom.', 'Welcome onboard! Explore the ship, attend the safety briefing, and enjoy the Welcome Cocktail and Dinner in the Ship\'s Restaurant.'],
