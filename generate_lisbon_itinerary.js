...
async function run() {
  ...
  const scheduleValues = [
      ...
      ['Day 1 (Sat Jul 18)', '01:30 PM', 'Pingo Doce Sete Rios Grocery Run', '5-10 min flat walk from the hotel.', 'Quick run for local Portuguese wines, fresh bakery items, and snacks. Avoid overpriced hotel shops—this is where the local neighborhood shops.'],
      ['Day 1 (Sat Jul 18)', '02:15 PM', 'Transit to Baixa-Chiado', 'Take Metro Blue Line from Sete Rios directly to Baixa-Chiado (15 min), or order an Uber.', 'Head to the city center for your afternoon private Tuk Tuk tour. Meet at Rua do Crucifixo.'],
      ['Day 1 (Sat Jul 18)', '02:45 PM', 'Arrive at Tuk Tuk Pickup Point', 'Rua do Crucifixo, Lisbon (near Baixa-Chiado Metro).', 'Arrive 15 minutes early. Meet your guide for the private tour.'],
      ['Day 1 (Sat Jul 18)', '03:00 PM', 'Private Tuk Tuk Tour (Old Town & Belém)', 'Extended 3.5-hour tour with city pickup. Drop-off in Alfama.', 'Booked (6 adults, Voucher: GYG996Z2KW72). Covers the historic quarters (Alfama, Mouraria, Chiado) and Belém (Torre de Belém, Pastéis de Belém, etc.). Private vehicle for the group.'],
      ['Day 1 (Sat Jul 18)', '06:30 PM', 'Tour Ends & Walk to Restaurant', 'Drop-off in Alfama (Largo do Chafariz de Dentro 1). Walk to Rua dos Sapateiros 177 (10-12 mins).', 'A leisurely flat walk from the Alfama waterfront back into the Baixa grid to reach your dinner venue.'],
      ['Day 1 (Sat Jul 18)', '07:00 PM', 'Dinner at Uma Marisqueira I', 'Rua dos Sapateiros 177, 1100-577 Lisboa.', 'Confirmed reservation for 6 people (7:00 PM - 8:30 PM) under Tsung-Pai Chen. Excellent local seafood and classic marisqueira environment.'],
      ['Day 1 (Sat Jul 18)', '08:30 PM', 'Return to Hotel', 'Take Metro Blue Line from Baixa-Chiado to Sete Rios, or grab an Uber directly to The Corinthia.', 'Return to the hotel to refresh and relax after your first day in Portugal.'],
      ...
      ['Day 2 (Sun Jul 19)', '04:15 PM', 'Aperitif at A Ginjinha', 'Flat walk from Baixa to Largo de São Domingos.', 'Sip a quick glass of wild sour cherry liqueur (ginja) at Lisbon\'s oldest counter, operating since 1840.'],
      ['Day 2 (Sun Jul 19)', '04:45 PM', 'Arrive at Fado Show & Wine', 'Short walk from Largo de São Domingos to Largo Santo António da Sé 5 (10-12 mins).', 'Arrive 15 minutes before the show. Check for the blue doors and our host at the entrance.'],
      ['Day 2 (Sun Jul 19)', '05:00 PM', 'Lisbon: Top-Rated Authentic Fado Show & Wine', 'Fado & Fado - Sé. Duration: 50 minutes.', 'Booked (6 adults, Voucher: GYG7VKV8HF9A for 2 adults + rest of group booked separately). Soulful live Fado music paired with local Portuguese wine.'],
      ['Day 2 (Sun Jul 19)', '05:50 PM', 'Leisurely Walk to Baixa', 'Downhill stroll from the Sé Cathedral back to the Baixa flats.', 'Enjoy the historic streets and viewpoints as the late afternoon light illuminates the city.'],
      ['Day 2 (Sun Jul 19)', '07:00 PM', 'Dinner at O Castiço', 'Rua dos Sapateiros 81, 1100-576 Lisboa.', 'Confirmed reservation for 6 people (7:00 PM - 9:00 PM) under Tsung-Pai Chen. A cozy, traditional restaurant serving excellent local Portuguese cuisine.'],
      ['Day 2 (Sun Jul 19)', '09:00 PM', 'Return to Hotel', 'Walk to Baixa-Chiado Metro station and take Blue Line to Sete Rios, or grab a quick Uber.', 'Return to The Corinthia Lisbon to rest up for your Sintra tour tomorrow.'],
      ...
      ['Day 3 (Mon Jul 20)', '07:00 PM', 'Dinner at Duque', 'Rua do Duque 5, 1200-158 Lisboa. Short walk from Rossio/Baixa-Chiado. Return to Corinthia via Metro Blue Line or Uber.', 'Confirmed reservation for 6 people (7:00 PM - 8:30 PM) under Tsung-Pai Chen (Ref: 106402507, Phone: +351 213 428 579). Traditional Portuguese restaurant offering a cozy atmosphere and local dishes.'],
    ...
    const bookingValues = [
      ...
      ['Tour', 'Private Tuk Tuk Tour (Extended Old Town & Belém)', 'Saturday, July 18, 2026 (03:00 PM)', 'Tripzuo (Pickup: Rua do Crucifixo, Baixa-Chiado)', 'Booked (6 adults, Voucher: GYG996Z2KW72, PIN: rzcqXP/x)'],
      ['Restaurant', 'Uma Marisqueira I', 'Saturday, July 18, 2026 (07:00 PM)', 'Rua dos Sapateiros 177, 1100-577 Lisboa', 'Booked (6 people, Ref: 106210300)'],
      ['Tour', 'Authentic Fado Show & Wine (Fado & Fado - Sé)', 'Sunday, July 19, 2026 (05:00 PM)', 'Largo Santo António da Sé 5, 1100-171 Lisboa', 'Booked (6 adults total, Voucher: GYG7VKV8HF9A for 2 + rest of group booked separately)'],
      ['Restaurant', 'O Castiço', 'Sunday, July 19, 2026 (07:00 PM)', 'Rua dos Sapateiros 81, 1100-576 Lisboa', 'Booked (6 people, Ref: 106210273)'],
      ...
      ['Restaurant', 'Duque', 'Monday, July 20, 2026 (07:00 PM)', 'Rua do Duque 5, 1200-158 Lisboa', 'Booked (6 people, Ref: 106402507)'],
